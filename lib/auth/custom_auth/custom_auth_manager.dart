...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    frexFinalAuthUserSubject.add(
      FrexFinalAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<FrexFinalAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  FrexFinalAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = FrexFinalAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    frexFinalAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
