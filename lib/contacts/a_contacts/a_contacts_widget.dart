...
import 'a_contacts_model.dart';
export 'a_contacts_model.dart';

class AContactsWidget extends StatefulWidget {
  const AContactsWidget({super.key});

  static String routeName = 'aContacts';
  static String routePath = '/aContacts';

  @override
  State<AContactsWidget> createState() => _AContactsWidgetState();
}

class _AContactsWidgetState extends State<AContactsWidget>
    with TickerProviderStateMixin {
  late AContactsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AContactsModel());
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        MenuContactSingleWidget.routeName,
                                        queryParameters: {
                                          'data': serializeParam(
