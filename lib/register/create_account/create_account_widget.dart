...
class _CreateAccountWidgetState extends State<CreateAccountWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController1?.text = 'Andrew';
        }));
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Padding(
            ...
            child: LinearPercentIndicator(
              percent: _model.pageViewCurrentIndex / 6,
              width: 220.0,
              lineHeight: 12.0,
              animation: true,
        ...
        body: Column(
          ...
          children: [
                                                              ...
                                                              image:
                                                                ...
                                                                image: Image
                                                                  ...
                                                                  valueOrDefault<
                                                                    ...
                                                                    countryListItem
                                                                        .img,
                                                                    'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/fast-pay-znmge9/assets/f3g0vk41ngiu/27.png',
                                                                  ),
                                                                ).image,
                                                              ),
                                                              borderRadius:
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      15.0, 15.0, 0.0, 0.0),
                                  child: Text(
                                    'Choose a verification method. You will be asked for photo proof of residence in the next step.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      15.0, 30.0, 15.0, 0.0),
                                  child: Text(
                                    'But wait, you gotta take a selfie with ID card 🤳',
                                    style: FlutterFlowTheme.of(context)
                                        .headlineMedium
                                        .override(
                                          font: GoogleFonts.openSans(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      15.0, 15.0, 15.0, 0.0),
                                  child: Text(
                                    'Don\'t worry, your data remains safe and private. Only you can see it.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
            ...
            if (_model.pageViewCurrentIndex != 0)
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(15.0, 12.0, 15.0, 25.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (_model.pageViewCurrentIndex >= 6) {
                            context.pushNamed(ReadyAccountWidget.routeName);
                          } else {
                            await _model.pageViewController?.nextPage(
                              duration: Duration(milliseconds: 300),
                              curve: Curves.ease,
