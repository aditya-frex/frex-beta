...
import 'menu_send_model.dart';
export 'menu_send_model.dart';

class MenuSendWidget extends StatefulWidget {
  const MenuSendWidget({super.key});

  static String routeName = 'MenuSend';
  static String routePath = '/menuSend';

  @override
  State<MenuSendWidget> createState() => _MenuSendWidgetState();
}

class _MenuSendWidgetState extends State<MenuSendWidget>
    with TickerProviderStateMixin {
  late MenuSendModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuSendModel());
