...
import 'deactivate_account_model.dart';
export 'deactivate_account_model.dart';
...
class _DeactivateAccountWidgetState extends State<DeactivateAccountWidget> {
  late DeactivateAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeactivateAccountModel());
  }
                        ...
                        Expanded(
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              context.goNamedAuth(AWalkthroughWidget.routeName,
                                  context.mounted);
                            },
                            text: 'Yes, I\'m sure',
                            options: FFButtonOptions(
