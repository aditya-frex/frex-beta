...
import 'e_payment_method3_model.dart';
export 'e_payment_method3_model.dart';

class EPaymentMethod3Widget extends StatefulWidget {
  const EPaymentMethod3Widget({
    super.key,
    bool? fromWithdraw,
  }) : this.fromWithdraw = fromWithdraw ?? false;

  final bool fromWithdraw;

  static String routeName = 'ePaymentMethod3';
  static String routePath = '/ePaymentMethod3';

  @override
  State<EPaymentMethod3Widget> createState() => _EPaymentMethod3WidgetState();
}

class _EPaymentMethod3WidgetState extends State<EPaymentMethod3Widget> {
  late EPaymentMethod3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EPaymentMethod3Model());
    ...
    _model.expireMask = MaskTextInputFormatter(mask: '##/##');
    _model.cvvTextController ??= TextEditingController();
    _model.cvvFocusNode ??= FocusNode();

    _model.cvvMask = MaskTextInputFormatter(mask: '###');
  }
