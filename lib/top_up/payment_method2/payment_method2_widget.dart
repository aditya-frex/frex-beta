...
import '/top_up/wait_add_payment_method/wait_add_payment_method_widget.dart';
import '/withdraw/wait_payment_method/wait_payment_method_widget.dart';
import 'dart:ui';
...
class PaymentMethod2Widget extends StatefulWidget {
  ...
  static String routeName = 'PaymentMethod2';
  static String routePath = '/paymentMethod2';
                        ...
                        builder: (dialogContext) {
                          return Dialog(
                            ...
                            child: GestureDetector(
                              ...
                              child: WaitAddPaymentMethodWidget(),
                            ),
                          );
                        },
                      );
