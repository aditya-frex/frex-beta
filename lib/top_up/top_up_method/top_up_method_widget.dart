...
export 'top_up_method_model.dart';

class TopUpMethodWidget extends StatefulWidget {
  const TopUpMethodWidget({super.key});

  static String routeName = 'TopUpMethod';
  static String routePath = '/topUpMethod';

  @override
  State<TopUpMethodWidget> createState() => _TopUpMethodWidgetState();
}

class _TopUpMethodWidgetState extends State<TopUpMethodWidget> {
  late TopUpMethodModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopUpMethodModel());
  }
            ...
            Builder(
              builder: (context) => Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(TopUpNowWidget.routeName);
                                    },
                  text: 'Continue',
